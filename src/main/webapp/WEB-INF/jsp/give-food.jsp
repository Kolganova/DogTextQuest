...
<div class="content">
    ...
    <div class="text-form-container">
        <h4>
            ...
            <br>
            Он задорно спрыгивает сам и забирает из твоей сумки припрятанную на черный день колбаску и ест смотря прямо
            тебе в глаза.
            <br>
        </h4>
        <p>Позволишь псу себя так вести?</p>
            ...
            <c:forEach var="giveFoodAcceptance" items="${requestScope.giveFoodAcceptance}">
                <label>
                    <input type="radio" name="giveFoodAcceptance"
                           value="${giveFoodAcceptance}" required>
